...
const DefaultVerificationForm = 
    ...
    ({nextPath = '/account/login', homePath = '/account/login', submitLabel = 'Verify', ...args} = {}) => (

    <VerificationComponent successPath={nextPath} cancelPath={homePath}>
    {
                ...
                <fieldset>
                    <ul className="form-list">
                        ...
                        <li className="l_center">
                            <div className="buttons-set">
                                <a className="link" id="resend" href="#" onClick={callback.resend}>
